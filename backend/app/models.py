...
class Project(Base):
    ...
    # Uploaded voiceover for the whole project (replaces per-scene TTS
    # generation) — upload this BEFORE triggering /generate so the
    # orchestrator can rescale shot timing + captions to match real speech.
    narration_audio_uri = Column(String, nullable=True)
...
class Shot(Base):
    ...
    caption_text = Column(Text, nullable=True)               # the actual subtitle/caption words for this shot
